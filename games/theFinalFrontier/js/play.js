var playState = {
    ...
    create: function () {
    this.starfield = this.add.tileSprite(0, 0, 700, 900, 'starfield');
    ...
    this.gameMusic = game.add.audio('gameMusic',1,false);
    this.gameMusic.play();
  },
  ...
  setupPlayer: function () {
    this.player = this.add.sprite(350, 750, 'player');
  ...
  setupEnemies: function () {
    ...
    this.shooterPool.createMultiple(20, 'enemyship');
  ...
  setupText: function () {
    this.instructions = this.add.text( 350, 600, 
  ...
  render: function() {
    // render hitboxes for enemies to make harder
  },
  ...
  spawnBoss: function () {
    ...
    this.boss.reset(350, 0, this.bossInitialHealth);
  ...
  quitGame: function (pointer) {
    ...
    //  Here we destroy everything we no longer need.
